...
<br>
Note: I do not use Arch right now. When I do get around to using it in a few years time, i will remove this messsage. For now, I specifically use Windows and Mint. I can't comment out the Arch badge because Markdown doesn't have comments. Thank you
